...
<cfcomponent name="DequeTest" extends="mxunit.framework.TestCase">
  ...
  <cffunction name="testpop" access="public" returnType="void">
    ...
    <cfset assertTrue( 'anItem' eq this.myComp.pop() ) />
  </cffunction>
  ...
  <cffunction name="setUp" returntype="void" access="public">
    <cfset this.myComp = createObject("component","org.gliint.util.Deque").init() />
  </cffunction>
