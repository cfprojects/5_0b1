<cfcomponent name="CommandHandlingExecutionChainTest" extends="mxunit.framework.TestCase">
...
--->
	...
	<cffunction name="testinit" access="public" returnType="void">
		<cfset assertIsTypeOf( this.myComp, 'org.gliint.framework.handler.CommandHandlingExecutionChain' ) />
	</cffunction>
...
--->
	...
	<cffunction name="setUp" returntype="void" access="public">
		...
		<cfset this.myComp = createObject( 'component', 'org.gliint.framework.handler.CommandHandlingExecutionChain' ).init() />
	</cffunction>
