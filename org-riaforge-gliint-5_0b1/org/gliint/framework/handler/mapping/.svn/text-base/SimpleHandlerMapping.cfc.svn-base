<cfcomponent displayname="SimpleHandlerMapping" extends="org.gliint.framework.handler.mapping.BaseHandlerMapping" output="false">
<!---
Returns a HandlerExecutionChain for a request if the targetPage is index.cfm.
...
--->
<!---
org.gliint.framework.handler.mapping.SimpleHandlerMapping
...
--->
	...
	<cffunction name="init" access="public" returntype="org.gliint.framework.handler.mapping.SimpleHandlerMapping" output="false">
		<cfreturn this />
	</cffunction>
	...
	<cffunction name="getHandler" access="public" returntype="any" output="false">
		...
		<cfif ( listFindNoCase( 'index.cfm', targetPage, '/' ) neq 0 ) >
			...
			<cfif getShouldTrace() >
				<cftrace type="information" text="org.gliint.framework.handler.mapping.SimpleHandlerMapping: Created a HandlerExecutionChain with the defaultHandler (#getmetadata( getDefaultHandler() ).name#)" />
				<cftrace type="information" text="org.gliint.framework.handler.mapping.SimpleHandlerMapping: Added Interceptor htmlConnector to the HandlerExecutionChain" />
			</cfif>
			<cfreturn hec />
		</cfif>

		<cfif getShouldTrace() >
			<cftrace type="warning" text="org.gliint.framework.handler.mapping.SimpleHandlerMapping: Did NOT create a HandlerExecutionChain" />
		</cfif>
		<cfreturn FALSE />
	</cffunction>
