<cfcomponent displayname="Nop" extends="org.gliint.framework.handler.BaseCommandHandler" output="false" >
<!---
A no-op commandHandler
...
--->
<!---
org.gliint.framework.lexicon.Nop
...
--->
	...
	<cffunction name="init" access="public" returntype="org.gliint.framework.lexicon.Nop" output="false">
		<cfset super.init() />
		<cfreturn this />
	</cffunction>
  ...
  <cffunction name="execute" access="public" returntype="any" output="false">
    ...
    <cfif getShouldTrace() >
      <cftrace type="information" text="org.gliint.framework.lexicon.Nop started" />
    </cfif>

		<!--- this, right here, is your no-op --->

    <cfif getShouldTrace() >
      <cftrace type="information" text="org.gliint.framework.lexicon.Nop completed" />
    </cfif>
